                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12">
                        <div class="about-img rs-animation-hover">
							<img src="main/images/about/about.jpg" alt="img02"/>
						...
						@if($course->course_discount!=0)
			                <div class="cource-item">
			                    <div class="cource-img">
									...
									$sale= ($course ->course_price)-(($course ->course_price) * ($course-> course_discount))/100 ;
			                       echo "<span class='course-value'>".$sale."$</span>"
									@endphp
			                    </div>
					...
					<div class="col-lg-6 col-md-12">
						<div class="counter-content">
                			...
                			<div class="counter-img rs-image-effect-shine">
								<img src="main/images/counter/1.jpg" alt="Counter Discussion">
                			</div>
                		</div>
                	</div>
                		...
                		<div class="row">
		                    ...
		                    <div class="col-md-6">
								<div class="rs-counter-list">
		                            ...
		                            <h4 class="counter-desc">TESTS</h4>
		                        </div>
		                    </div>
                		</div>
                	</div>
		  ...
		  <div id="rs-calltoaction" class="rs-calltoaction sec-spacer bg4">
            <div class="container">
                <div class="rs-cta-inner text-center">
                    <div class="sec-title mb-50 text-center">
                        <h2 class="white-color">Test dates, fees and locations</h2>      
                        <p class="white-color">Find out which test is best for you, and choose between in paper-based and computer-delivered tests.</p>
                    </div>
				    <a class="cta-button" href="https://www.britishcouncil.jo/en/exam/ielts/dates-fees-locations">BOOK NOW</a>
				</div>
            </div>
        </div>
        <!-- Calltoaction End -->
