...
@section('content')
    <h3 class="page-title">@lang('Add question')</h3>
    ...
    {!! Form::submit(trans('submit'), ['class' => 'btn btn-primary mb-3' ]) !!}
    {!! Form::close() !!}
            ...
            <table class="table table-bordered  dt-select" id="dataTable" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        ...
                        <th>@lang('The topic')</th>
                        <th>@lang('Question text')</th>
                        <th>@lang('Question explication')</th>
                    ...
                    @if (count($questions) > 0)
                        @foreach ($questions as $question)
                            <tr data-entry-id="{{ $question->id }}">
                                ...
                                <td><a href="{{ route('questions.edit',[$question->id]) }}" class="btn btn-xl btn-info">@lang('Edit')</a></td>
                                <td>     {!! Form::open(array(
